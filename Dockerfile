...
RUN apt-get update && apt-get upgrade -y \
    ...
    && apt-get install -y --no-install-recommends gnupg curl ca-certificates zip unzip git sqlite3 libcap2-bin libpng-dev python3 dnsutils librsvg2-bin fswatch ffmpeg nano redis-server sudo \
